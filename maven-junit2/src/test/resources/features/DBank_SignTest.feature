Feature: Sign up functions
  ...
  Scenario: Opening a new chq account
    When a user opens a new checking account as follows:
      | accountType       | ownershipType | accountName | depositAmount |
      | Interest Checking | Joint         | First Chq   | 100
    Then a new checking account is created